...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .and().authorizeHttpRequests().requestMatchers(HttpMethod.POST,"/candidato/**").permitAll()
                .and().authorizeHttpRequests().requestMatchers(HttpMethod.POST,"/empresa/**").permitAll()
